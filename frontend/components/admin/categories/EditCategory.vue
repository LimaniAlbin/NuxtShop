<template>
  <base-modal v-if="dataLoaded" title="Edit Category" :visible="showModal" :is-loading="isPending" @submit="onEditCategory" @close="closeModal">
    <form @submit.prevent="onEditCategory">
...
const onEditCategory = async () => {
  ...
  mutate({ id: props.id, data: payload });
};
